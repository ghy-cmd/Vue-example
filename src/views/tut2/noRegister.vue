            ...
            >
              <div class="article-card-container">
                ...
                <div class="article-wrapper">
                  <div style="line-height:1.4" @click="logout()">
                    <router-link to="">
...
<script>
import { noRegister_loadArticles } from "@/api/api";
import TopNavBar from "@/components/layout/TopNavBar_noRegister";
...
export default {
    ...
    return {
      ...
      userInformation: {
        personalInformation: {
          ...
          username: "游客",
          userImage:
            "http://192.168.43.123:8089/ssm_war_exploded/logos/default_portrait.png",
  ...
  methods: {
    infiniteHandler($state) {
      noRegister_loadArticles(this.lastArticleId).then(response => {
